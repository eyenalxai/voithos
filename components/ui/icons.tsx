...
export const IconOpenAI = ({ className, ...props }: ComponentProps<'svg'>) => (
  <svg
    fill="currentColor"
    viewBox="0 0 24 24"
    role="img"
...
export const IconUser = ({ className, ...props }: ComponentProps<'svg'>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 256 256"
    fill="currentColor"
...
export const IconCheck = ({ className, ...props }: ComponentProps<'svg'>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 256 256"
    fill="currentColor"
...
export const IconBxsErrorCircle = ({
  className,
  ...props
}: ComponentProps<'svg'>) => (
  <svg
